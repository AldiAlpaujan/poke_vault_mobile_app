...
// expired
const String _kSha1DstX3 = 'DAC9024F54D8F6DF94935FB1732638CA6AD77C13';
  ...
  HttpClient createHttpClient(SecurityContext? context) {
    ...
    client.badCertificateCallback =
        (X509Certificate cert, String host, int port) =>
            _hexconverter(cert.sha1) == _kSha1DstX3;
    return client;
  }
}

void applyIsrgPatch() {
  if (Platform.isAndroid) HttpOverrides.global = LEHttpOverrides();
}
