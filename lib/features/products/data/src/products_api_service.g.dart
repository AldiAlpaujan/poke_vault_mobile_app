...
class _ProductsApiService implements ProductsApiService {
  ...
  @override
  Future<HttpResponse<ProductRes>> getProducts(ProductReq request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(request.toJson());
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ProductRes>>(
  ...
  Future<HttpResponse<DefaultRes>> createProducts(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DefaultRes _value;
    try {
      _value = DefaultRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  Future<HttpResponse<ProductCategoryLookupRes>> productCategoryLookup(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ProductCategoryLookupRes>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductCategoryLookupRes _value;
    try {
      _value = ProductCategoryLookupRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
